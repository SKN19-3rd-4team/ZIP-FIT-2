# Generated by Django 6.0 on 2025-12-07 09:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annc_url', models.URLField(max_length=2000, verbose_name='공고 URL')),
                ('created_dttm', models.DateTimeField(verbose_name='공고 생성 일자')),
                ('updated_dttm', models.DateTimeField(verbose_name='공고 수정 일자')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_path', models.CharField(max_length=2000, verbose_name='공고 파일 경로')),
                ('file_ext', models.CharField(max_length=10, verbose_name='공고 파일 확장자')),
                ('file_size', models.IntegerField(verbose_name='공고 파일 사이즈')),
                ('annc_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='chatbot.anncall', verbose_name='공고 ID')),
            ],
            options={
                'verbose_name': '공고 파일',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_key', models.UUIDField(verbose_name='세션 키')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annc_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='chatbot.anncall', verbose_name='공고 ID')),
                ('file_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='chatbot.anncfiles', verbose_name='공고 파일 ID')),
            ],
            options={
