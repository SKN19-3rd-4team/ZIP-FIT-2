...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AnncAll',
            fields=[
                ('annc_id', models.BigAutoField(primary_key=True, serialize=False, verbose_name='공고 ID')),
                ('annc_title', models.CharField(max_length=200, verbose_name='공고 제목')),
                ('annc_url', models.URLField(max_length=2000, unique=True, verbose_name='공고 URL')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='공고 생성 일자')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='공고 수정 일자')),
        ...
        migrations.CreateModel(
            name='AnncLhTemp',
            fields=[
                ('temp_id', models.BigAutoField(primary_key=True, serialize=False, verbose_name='장고를 위한 SEQ')),
                ...
                ('batch_end_dttm', models.DateTimeField(blank=True, null=True, verbose_name='배치 완료 시간')),
        ...
        migrations.CreateModel(
            name='Chat',
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False, verbose_name='채팅 ID')),
                ('session_key', models.UUIDField(unique=True, verbose_name='세션 키')),
                ('user_key', models.CharField(max_length=100, verbose_name='사용자 고유키')),
                ('title', models.CharField(default='새로운 채팅', max_length=200, verbose_name='채팅 제목')),
        ...
        migrations.CreateModel(
            name='AnncFiles',
            fields=[
                ('file_id', models.BigAutoField(primary_key=True, serialize=False, verbose_name='공고 파일 ID')),
                ...
                ('file_path', models.CharField(max_length=2000, null=True, verbose_name='공고 파일 경로')),
                ('file_ext', models.CharField(max_length=10, verbose_name='공고 파일 확장자')),
                ('file_size', models.IntegerField(verbose_name='공고 파일 사이즈')),
                ('annc_id', models.ForeignKey(db_column='annc_id', on_delete=django.db.models.deletion.CASCADE, to='chatbot.anncall', verbose_name='공고 ID')),
            ],
            options={
                'verbose_name': '공고 파일',
        ...
        migrations.CreateModel(
            name='ChatMessage',
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False, verbose_name='기록 ID')),
                ...
                ('message_type', models.CharField(choices=[('system', 'System Message'), ('user', 'User Message'), ('bot', 'Bot Response')], max_length=6, verbose_name='메시지 유형')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='생성일시')),
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='history', to='chatbot.chat', verbose_name='채팅 세션')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='DocChunks',
            fields=[
                ('chunk_id', models.BigAutoField(primary_key=True, serialize=False, verbose_name='청크 ID')),
                ...
                ('embedding', pgvector.django.vector.VectorField(dimensions=1536, verbose_name='임베딩 벡터')),
                ('metadata', models.JSONField(verbose_name='메타데이터')),
                ('fts_vector', chatbot.models.TSVectorField(blank=True, null=True, verbose_name='전문 검색 벡터')),
                ('annc_id', models.ForeignKey(db_column='annc_id', on_delete=django.db.models.deletion.CASCADE, to='chatbot.anncall', verbose_name='공고 ID')),
                ('file_id', models.ForeignKey(db_column='file_id', on_delete=django.db.models.deletion.CASCADE, to='chatbot.anncfiles', verbose_name='공고 파일 ID')),
            ],
            options={
